...
static u8 ChooseWildMonIndex_Fishing(u8 rod)
{
    ...
    case GOOD_ROD:
        if (rand < ENCOUNTER_CHANCE_FISHING_MONS_GOOD_ROD_SLOT_3)
            ...
            wildMonIndex = 4;
        else if (rand >= ENCOUNTER_CHANCE_FISHING_MONS_GOOD_ROD_SLOT_4 && rand < ENCOUNTER_CHANCE_FISHING_MONS_GOOD_ROD_SLOT_5)
            wildMonIndex = 5;
        break;
    case SUPER_ROD:
        if (rand < ENCOUNTER_CHANCE_FISHING_MONS_SUPER_ROD_SLOT_6)
            ...
            wildMonIndex = 9;
        else if (rand >= ENCOUNTER_CHANCE_FISHING_MONS_SUPER_ROD_SLOT_9 && rand < ENCOUNTER_CHANCE_FISHING_MONS_SUPER_ROD_SLOT_10)
            wildMonIndex = 10;
        break;
    }
    return wildMonIndex;
...
static bool8 IsAbilityAllowingEncounter(u8 level)
{
    ...
    if (ability == ABILITY_KEEN_EYE || ability == ABILITY_INTIMIDATE || ability == ABILITY_TERRIFLYING)
    {

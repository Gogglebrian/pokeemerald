...
static const struct TrainerMonNoItemCustomMoves sParty_Felix[] = {
    ...
    .moves = {MOVE_ZEN_HEADBUTT, MOVE_DRAIN_PUNCH, MOVE_ICE_PUNCH, MOVE_FIRE_PUNCH}
    },
    {
    .iv = 0,
    .lvl = 43,
    .species = SPECIES_CLAYDOL,
    .moves = {MOVE_SKILL_SWAP, MOVE_EARTH_POWER, MOVE_PSYCHIC, MOVE_RECOVER}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Dusty1[] = {
    ...
    .moves = {MOVE_DIG, MOVE_CRUSH_CLAW, MOVE_SAND_ATTACK, MOVE_FURY_CUTTER}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Chip[] = {
    ...
    .lvl = 27,
    .species = SPECIES_SANDSLASH,
    .moves = {MOVE_DIG, MOVE_CRUSH_CLAW, MOVE_SAND_ATTACK, MOVE_POISON_JAB}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Foster[] = {
    ...
    .lvl = 25,
    .species = SPECIES_SANDSLASH,
    .moves = {MOVE_DIG, MOVE_SLASH, MOVE_SAND_ATTACK, MOVE_POISON_JAB}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Dusty3[] = {
    ...
    .lvl = 30,
    .species = SPECIES_SANDSLASH,
    .moves = {MOVE_DIG, MOVE_SLASH, MOVE_POISON_JAB, MOVE_SHADOW_CLAW}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Dusty4[] = {
    ...
    .lvl = 33,
    .species = SPECIES_SANDSLASH,
    .moves = {MOVE_DIG, MOVE_SLASH, MOVE_POISON_JAB, MOVE_SWORDS_DANCE}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Dusty5[] = {
    ...
    .lvl = 36,
    .species = SPECIES_SANDSLASH,
    .moves = {MOVE_EARTHQUAKE, MOVE_POISON_JAB, MOVE_STONE_EDGE, MOVE_SWORDS_DANCE}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_GabbyAndTy6[] = {
    ...
    .lvl = 39,
    .species = SPECIES_MAGNETON,
    .moves = {MOVE_FLASH_CANNON, MOVE_TRI_ATTACK, MOVE_METAL_SOUND, MOVE_THUNDERBOLT}
    },
    {
    .iv = 250,
    .lvl = 39,
    .species = SPECIES_EXPLOUD,
    .moves = {MOVE_CRUNCH, MOVE_STOMP, MOVE_SUPERSONIC, MOVE_HYPER_VOICE}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Ricky2[] = {
    ...
    .moves = {MOVE_EXTREME_SPEED, MOVE_PIN_MISSILE, MOVE_DIG, MOVE_SURF}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Randall[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_QUICK_ATTACK, MOVE_AGILITY, MOVE_WING_ATTACK, MOVE_STEEL_WING}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Parker[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_TEETER_DANCE, MOVE_DIZZY_PUNCH, MOVE_FOCUS_PUNCH, MOVE_HYPNOSIS}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_George[] = {
    ...
    .moves = {MOVE_SLACK_OFF, MOVE_COUNTER, MOVE_SHADOW_CLAW, MOVE_COVET}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Berke[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_FOCUS_ENERGY, MOVE_SLASH, MOVE_SHADOW_CLAW, MOVE_PURSUIT}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Braxton[] = {
    ...
    .moves = {MOVE_CRUNCH, MOVE_DIG, MOVE_ROCK_SLIDE, MOVE_SAND_TOMB}
    },
    {
    .iv = 100,
    .lvl = 28,
...
static const struct TrainerMonItemCustomMoves sParty_Mary[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_COVET, MOVE_SHOCK_WAVE, MOVE_FAKE_OUT, MOVE_CHARM}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Alexia[] = {
    ...
    .species = SPECIES_WIGGLYTUFF,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_DEFENSE_CURL, MOVE_DOUBLE_EDGE, MOVE_PLAY_ROUGH, MOVE_SING}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Jody[] = {
    ...
    .species = SPECIES_ZANGOOSE,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SWORDS_DANCE, MOVE_SLASH, MOVE_SHADOW_CLAW, MOVE_REVENGE}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Wendy[] = {
    ...
    .lvl = 29,
    .species = SPECIES_MAWILE,
    .moves = {MOVE_BATON_PASS, MOVE_CRUNCH, MOVE_IRON_DEFENSE, MOVE_VICE_GRIP}
    },
    {
    .iv = 100,
    .lvl = 29,
    .species = SPECIES_ROSELIA,
    .moves = {MOVE_GIGA_DRAIN, MOVE_VENOSHOCK, MOVE_GRASS_WHISTLE, MOVE_LEECH_SEED}
    },
    {
    .iv = 100,
    .lvl = 29,
    .species = SPECIES_PELIPPER,
    .moves = {MOVE_FLY, MOVE_SURF, MOVE_MIST, MOVE_PROTECT}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Daphne[] = {
    ...
    .species = SPECIES_LUDICOLO,
    .heldItem = ITEM_NUGGET,
    .moves = {MOVE_ATTRACT, MOVE_SURF, MOVE_FLAIL, MOVE_ENERGY_BALL}
    },
    {
    .iv = 100,
    .lvl = 39,
    ...
    .heldItem = ITEM_NUGGET,
    .moves = {MOVE_ATTRACT, MOVE_SWEET_KISS, MOVE_WATER_PULSE, MOVE_MIST_BALL}
    }
};
...
static const struct TrainerMonItemDefaultMoves sParty_Cindy6[] = {
    {
    .iv = 40,
    .lvl = 36,
    .species = SPECIES_LINOONE,
...
static const struct TrainerMonNoItemCustomMoves sParty_Jessica1[] = {
    ...
    .lvl = 29,
    .species = SPECIES_KECLEON,
    .moves = {MOVE_SHADOW_SNEAK, MOVE_ANCIENT_POWER, MOVE_SLASH, MOVE_FAINT_ATTACK}
    },
    {
    .iv = 0,
    .lvl = 29,
...
static const struct TrainerMonNoItemCustomMoves sParty_Jessica2[] = {
    ...
    .lvl = 35,
    .species = SPECIES_KECLEON,
    .moves = {MOVE_SHADOW_CLAW, MOVE_ANCIENT_POWER, MOVE_SLASH, MOVE_FAINT_ATTACK}
    },
    {
    .iv = 10,
    .lvl = 35,
...
static const struct TrainerMonItemDefaultMoves sParty_Winston5[] = {
    {
    .iv = 0,
    .lvl = 36,
    .species = SPECIES_LINOONE,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Kirk[] = {
    {
    .iv = 100,
    .lvl = 17,
    .species = SPECIES_ELECTRIKE,
...
static const struct TrainerMonNoItemCustomMoves sParty_Drew[] = {
    ...
    .lvl = 23,
    .species = SPECIES_SANDSLASH,
    .moves = {MOVE_DIG, MOVE_SAND_ATTACK, MOVE_POISON_STING, MOVE_CRUSH_CLAW}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Beau[] = {
    ...
    .lvl = 21,
    .species = SPECIES_TRAPINCH,
	.moves = {MOVE_BIDE, MOVE_SAND_TOMB, MOVE_SAND_ATTACK, MOVE_BITE}
    },
    {
    .iv = 0,
    .lvl = 21,
    ...
    .lvl = 21,
    .species = SPECIES_BALTOY,
    .moves = {MOVE_RAPID_SPIN, MOVE_COSMIC_POWER, MOVE_PSYBEAM, MOVE_ROCK_TOMB}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Edward[] = {
    ...
    .moves = {MOVE_HIDDEN_POWER, MOVE_CONFUSION, MOVE_DISABLE, MOVE_DISARMING_VOICE}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Jaclyn[] = {
    ...
    .lvl = 16,
    .species = SPECIES_KADABRA,
    .moves = {MOVE_HIDDEN_POWER, MOVE_SWIFT, MOVE_PSYWAVE, MOVE_KINESIS}
    }
};
...
static const struct TrainerMonNoItemDefaultMoves sParty_Walter3[] = {
    {
    .iv = 20,
    .lvl = 36,
    .species = SPECIES_LINOONE,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Walter4[] = {
    {
    .iv = 30,
    .lvl = 39,
    .species = SPECIES_LINOONE,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Walter5[] = {
    {
    .iv = 40,
    .lvl = 41,
    .species = SPECIES_LINOONE,
...
static const struct TrainerMonItemCustomMoves sParty_Sidney[] = {
    ...
    .species = SPECIES_MUK,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_DRAIN_PUNCH, MOVE_GUNK_SHOT, MOVE_ACID_ARMOR, MOVE_CRUNCH}
    },
    {
    .iv = 250,
    .lvl = 46,
    .species = SPECIES_CACTURNE,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_LEECH_SEED, MOVE_FAINT_ATTACK, MOVE_NEEDLE_ARM, MOVE_POISON_JAB}
    },
	{
    .iv = 250,
    .lvl = 46,
    .species = SPECIES_EXPLOUD,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_DARK_PULSE, MOVE_HYPER_VOICE, MOVE_REST, MOVE_SLEEP_TALK}
    },
	{
    .iv = 250,
    .lvl = 48,
    .species = SPECIES_ELECTRODE,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_FLASH_CANNON, MOVE_DARK_PULSE, MOVE_DISCHARGE, MOVE_LIGHT_SCREEN}
    },
    {
    .iv = 250,
    .lvl = 48,
    .species = SPECIES_PINSIR,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_REVENGE, MOVE_SWORDS_DANCE, MOVE_X_SCISSOR, MOVE_CRUNCH}
    },
    {
    .iv = 255,
    .lvl = 49,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_AERIAL_ACE, MOVE_ROCK_SLIDE, MOVE_SWORDS_DANCE, MOVE_NIGHT_SLASH}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Phoebe[] = {
    ...
    .species = SPECIES_CHIMECHO,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_PSYCHIC, MOVE_HYPER_VOICE, MOVE_SHADOW_BALL, MOVE_ENERGY_BALL}
    },
    {
    .iv = 250,
    .lvl = 49,
    .species = SPECIES_NINETALES,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_HEX, MOVE_SACRED_FIRE, MOVE_WILL_O_WISP, MOVE_DARK_PULSE}
    },
    {
    .iv = 250,
    .lvl = 50,
    .species = SPECIES_SABLEYE,
    .heldItem = ITEM_ENVIOLITE,
    .moves = {MOVE_SHADOW_BALL, MOVE_DOUBLE_TEAM, MOVE_POISON_JAB, MOVE_DARK_PULSE}
    },
    {
    .iv = 250,
    .lvl = 49,
    .species = SPECIES_BANETTE,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SHADOW_BALL, MOVE_PSYCHIC, MOVE_THUNDERBOLT, MOVE_PLAY_ROUGH}
    },
    {
    .iv = 255,
    .lvl = 51,
...
static const struct TrainerMonItemCustomMoves sParty_Glacia[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_LIGHT_SCREEN, MOVE_IRON_HEAD, MOVE_SHADOW_BALL, MOVE_ICE_BEAM}
    },
	{
    .iv = 250,
    .lvl = 50,
    .species = SPECIES_MANECTRIC,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_THUNDERBOLT, MOVE_CRUNCH, MOVE_ICE_BEAM, MOVE_HAIL}
    },
    {
    .iv = 250,
    .lvl = 52,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_WEATHER_BALL, MOVE_THUNDER_WAVE, MOVE_HAIL, MOVE_BLIZZARD}
    },
    {
    .iv = 250,
    .lvl = 52,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_SURF, MOVE_BODY_SLAM, MOVE_ICE_BEAM, MOVE_AVALANCHE}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Drake[] = {
    ...
    .heldItem = ITEM_EVIOLITE,
    .moves = {MOVE_IRON_HEAD, MOVE_DRAGON_CLAW, MOVE_SCARY_FACE, MOVE_DOUBLE_EDGE}
    },
	{
    .iv = 255,
    .lvl = 53,
    .species = SPECIES_GYARADOS,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_DRAGON_DANCE, MOVE_EARTHQUAKE, MOVE_GIGA_IMPACT, MOVE_AQUA_TAIL}
    },
    {
    .iv = 250,
    .lvl = 54,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_DOUBLE_EDGE, MOVE_DRAGON_PULSE, MOVE_DRAGON_DANCE, MOVE_AERIAL_ACE}
    },
    {
    .iv = 250,
    .lvl = 53,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_FLASH_CANNON, MOVE_DRAGON_DANCE, MOVE_SURF, MOVE_BODY_SLAM}
    },
    {
    .iv = 250,
    .lvl = 53,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_FLAMETHROWER, MOVE_CRUNCH, MOVE_DRAGON_RUSH, MOVE_EARTHQUAKE}
    },
    {
    .iv = 255,
    .lvl = 55,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_FLAMETHROWER, MOVE_DRAGON_CLAW, MOVE_IRON_HEAD, MOVE_CRUNCH}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Roxanne1[] = {
    ...
    .species = SPECIES_ARON,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_MUD_SLAP, MOVE_HARDEN, MOVE_METAL_CLAW, MOVE_ROCK_TOMB}
    },
    {
    .iv = 200,
    .lvl = 15,
...
static const struct TrainerMonItemCustomMoves sParty_Wattson1[] = {
    ...
    .species = SPECIES_MAGNETON,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_MAGNET_BOMB, MOVE_SHOCK_WAVE, MOVE_THUNDER_WAVE, MOVE_SONIC_BOOM}
    },
    {
    .iv = 250,
    .lvl = 24,
    .species = SPECIES_MANECTRIC,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_QUICK_ATTACK, MOVE_ICY_WIND, MOVE_SHOCK_WAVE, MOVE_HOWL}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Juan1[] = {
    ...
    .species = SPECIES_LUVDISC,
    .heldItem = ITEM_ENVIOLITE,
    .moves = {MOVE_WATER_PULSE, MOVE_ATTRACT, MOVE_SWEET_KISS, MOVE_DRAINING_KISS}
    },
    {
    .iv = 200,
    .lvl = 41,
    .species = SPECIES_GOLDUCK,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_RAIN_DANCE, MOVE_WATER_PULSE, MOVE_POWER_GEM, MOVE_MIST_BALL}
    },
    {
    .iv = 200,
    .lvl = 43,
    .species = SPECIES_SEADRA,
    .heldItem = ITEM_EVIOLITE,
    .moves = {MOVE_ICE_BEAM, MOVE_DRAGON_PULSE, MOVE_RAIN_DANCE, MOVE_WATER_PULSE}
    },
    {
    .iv = 200,
    .lvl = 43,
    .species = SPECIES_LANTURN,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_WATER_PULSE, MOVE_THUNDER, MOVE_SIGNAL_BEAM, MOVE_RAIN_DANCE}
    },
    {
    .iv = 250,
    .lvl = 46,
    ...
    .moves = {MOVE_WATER_PULSE, MOVE_BODY_SLAM, MOVE_MEGAHORN, MOVE_SLACK_OFF}
    }
};
...
static const struct TrainerMonNoItemDefaultMoves sParty_AnnaAndMeg1[] = {
    {
    .iv = 0,
    .lvl = 15,
...
static const struct TrainerMonNoItemDefaultMoves sParty_AnnaAndMeg2[] = {
    {
    .iv = 10,
    .lvl = 28,
    .species = SPECIES_SWALOT,
...
static const struct TrainerMonNoItemDefaultMoves sParty_AnnaAndMeg3[] = {
    {
    .iv = 20,
    .lvl = 31,
    .species = SPECIES_SWALOT,
...
static const struct TrainerMonNoItemDefaultMoves sParty_AnnaAndMeg4[] = {
    {
    .iv = 30,
    .lvl = 34,
    .species = SPECIES_SWALOT,
...
static const struct TrainerMonNoItemDefaultMoves sParty_AnnaAndMeg5[] = {
    {
    .iv = 40,
    .lvl = 36,
    .species = SPECIES_SWALOT,
...
static const struct TrainerMonNoItemCustomMoves sParty_Ben[] = {
    ...
    .lvl = 17,
    .species = SPECIES_PLUSLE,
	.moves = {MOVE_COVET, MOVE_QUICK_ATTACK, MOVE_GROWL, MOVE_SPARK}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Wallace[] = {
    ...
    .species = SPECIES_CRAWDAUNT,
    .heldItem = ITEM_ENVIOLITE,
    .moves = {MOVE_CRABHAMMER, MOVE_SWORDS_DANCE, MOVE_X_SCISSOR, MOVE_IRON_HEAD}
    },
    {
    .iv = 255,
    .lvl = 58,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Dianne[] = {
    {
    .iv = 0,
    .lvl = 43,
...
static const struct TrainerMonNoItemCustomMoves sParty_Lao1[] = {
    ...
    .lvl = 17,
    .species = SPECIES_KOFFING,
    .moves = {MOVE_POISON_GAS, MOVE_EMBER, MOVE_SMOG, MOVE_SELF_DESTRUCT}
    },
    {
    .iv = 0,
    .lvl = 17,
    .species = SPECIES_GRIMER,
	.moves = {MOVE_MUD_BOMB, MOVE_SLUDGE, MOVE_HARDEN, MOVE_DISABLE}
    },
    {
    .iv = 0,
    .lvl = 17,
    .species = SPECIES_SEVIPER,
	.moves = {MOVE_POISON_TAIL, MOVE_BITE, MOVE_SCREECH, MOVE_WRAP}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Lao2[] = {
    ...
    .lvl = 24,
    .species = SPECIES_KOFFING,
    .moves = {MOVE_WILL_O_WISP, MOVE_FIRE_SPIN, MOVE_SLUDGE, MOVE_SELF_DESTRUCT}
    },
    {
    .iv = 0,
    .lvl = 24,
    .species = SPECIES_KOFFING,
    .moves = {MOVE_WILL_O_WISP, MOVE_FIRE_SPIN, MOVE_SLUDGE, MOVE_SYNTHESIS}
    },
    {
    .iv = 0,
    .lvl = 24,
    .species = SPECIES_GRIMER,
	.moves = {MOVE_MUD_BOMB, MOVE_SLUDGE, MOVE_MINIMIZE, MOVE_DISABLE}
    },
    {
    .iv = 0,
    .lvl = 26,
    .species = SPECIES_SEVIPER,
	.moves = {MOVE_POISON_FANG, MOVE_BITE, MOVE_SCREECH, MOVE_WRAP}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Lao3[] = {
    ...
    .lvl = 27,
    .species = SPECIES_GRIMER,
	.moves = {MOVE_MUD_BOMB, MOVE_SLUDGE, MOVE_MINIMIZE, MOVE_SHADOW_SNEAK}
    },
    {
    .iv = 20,
    .lvl = 29,
    .species = SPECIES_SEVIPER,
	.moves = {MOVE_POISON_FANG, MOVE_NIGHT_SLASH, MOVE_SCREECH, MOVE_WRAP}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Lao4[] = {
    ...
    .lvl = 30,
    .species = SPECIES_GRIMER,
	.moves = {MOVE_MUD_BOMB, MOVE_SLUDGE_BOMB, MOVE_MINIMIZE, MOVE_SHADOW_SNEAK}
    },
    {
    .iv = 30,
    .lvl = 32,
...
static const struct TrainerMonItemCustomMoves sParty_Lao5[] = {
    ...
    .species = SPECIES_GRIMER,
    .heldItem = ITEM_NONE,
	.moves = {MOVE_MUD_BOMB, MOVE_POISON_JAB, MOVE_MINIMIZE, MOVE_SHADOW_SNEAK}
    },
    {
    .iv = 40,
    .lvl = 33,
    .species = SPECIES_KOFFING,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_WILL_O_WISP, MOVE_FIRE_SPIN, MOVE_SLUDGE_BOMB, MOVE_SELF_DESTRUCT}
    },
    {
    .iv = 40,
    .lvl = 33,
    .species = SPECIES_SEVIPER,
    .heldItem = ITEM_NONE,
	.moves = {MOVE_POISON_JAB, MOVE_NIGHT_SLASH, MOVE_SCREECH, MOVE_WRAP}
    },
    {
    .iv = 40,
    .lvl = 35,
    ...
    .moves = {MOVE_WILL_O_WISP, MOVE_HEAT_WAVE, MOVE_SLUDGE_BOMB, MOVE_SYNTHESIS}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Madeline1[] = {
    ...
    .lvl = 19,
    .species = SPECIES_VULPIX,
    .moves = {MOVE_FIRE_SPIN, MOVE_QUICK_ATTACK, MOVE_BABY_DOLL_EYES, MOVE_SUNNY_DAY}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Madeline2[] = {
    ...
    .lvl = 29,
    .species = SPECIES_VULPIX,
    .moves = {MOVE_FLAMETHROWER, MOVE_FAINT_ATTACK, MOVE_HEX, MOVE_SUNNY_DAY}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Madeline3[] = {
    ...
    .lvl = 32,
    .species = SPECIES_NINETALES,
    .moves = {MOVE_FLAMETHROWER, MOVE_HEX, MOVE_CONFUSE_RAY, MOVE_SUNNY_DAY}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Madeline4[] = {
    ...
    .lvl = 34,
    .species = SPECIES_ROSELIA,
    .moves = {MOVE_LEECH_SEED, MOVE_GIGA_DRAIN, MOVE_GRASS_WHISTLE, MOVE_SUNNY_DAY}
    },
    {
    .iv = 30,
    .lvl = 34,
...
static const struct TrainerMonNoItemCustomMoves sParty_Madeline5[] = {
    ...
    .lvl = 37,
    .species = SPECIES_NINETALES,
    .moves = {MOVE_SACRED_FIRE, MOVE_SHADOW_BALL, MOVE_CONFUSE_RAY, MOVE_SUNNY_DAY}
    }
};
...
static const struct TrainerMonNoItemDefaultMoves sParty_Becky[] = {
    {
    .iv = 0,
    .lvl = 22,
...
static const struct TrainerMonNoItemCustomMoves sParty_GinaAndMia2[] = {
    ...
    .lvl = 10,
    .species = SPECIES_SHROOMISH,
    .moves = {MOVE_ABSORB, MOVE_LEECH_SEED, MOVE_STUN_SPORE, MOVE_TACKLE}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Annika[] = {
    ...
    .species = SPECIES_MILOTIC,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_DRAGON_PULSE, MOVE_WATER_PULSE, MOVE_RETURN, MOVE_ATTRACT}
    },
    {
    .iv = 100,
    .lvl = 39,
    .species = SPECIES_STARMIE,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_POWER_GEM, MOVE_WATER_PULSE, MOVE_PSYCHIC, MOVE_MINIMIZE}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Jonas[] = {
    ...
    .lvl = 31,
    .species = SPECIES_KOFFING,
    .moves = {MOVE_TOXIC, MOVE_THUNDER, MOVE_FIRE_SPIN, MOVE_SLUDGE_BOMB}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Marley[] = {
    ...
    .species = SPECIES_MANECTRIC,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_BITE, MOVE_ICE_FANG, MOVE_THUNDER_WAVE, MOVE_THUNDERBOLT}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_WallyVR1[] = {
    ...
    .lvl = 44,
    .species = SPECIES_ALTARIA,
    .moves = {MOVE_AERIAL_ACE, MOVE_SAFEGUARD, MOVE_DRAGON_PULSE, MOVE_DRAGON_DANCE}
    },
    {
    .iv = 150,
    .lvl = 43,
    .species = SPECIES_DELCATTY,
    .moves = {MOVE_SING, MOVE_PLAY_ROUGH, MOVE_CHARM, MOVE_FAINT_ATTACK}
    },
    {
    .iv = 150,
    .lvl = 44,
...
static const struct TrainerMonItemCustomMoves sParty_Athena[] = {
    ...
    .species = SPECIES_MANECTRIC,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_THUNDER, MOVE_THUNDER_WAVE, MOVE_ICE_FANG, MOVE_BITE}
    },
    {
    .iv = 100,
    .lvl = 32,
    .species = SPECIES_LINOONE,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SURF, MOVE_DIG, MOVE_EXTREME_SPEED, MOVE_COVET}
    }
};
...
static const struct TrainerMonNoItemDefaultMoves sParty_Lucas2[] = {
    {
    .iv = 0,
    .lvl = 9,
    .species = SPECIES_WAILMER,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Mike1[] = {
    {
    .iv = 0,
    .lvl = 10,
    .species = SPECIES_GEODUDE,
...
static const struct TrainerMonNoItemCustomMoves sParty_Gerald[] = {
    ...
    .lvl = 23,
    .species = SPECIES_KECLEON,
    .moves = {MOVE_FLAMETHROWER, MOVE_FURY_SWIPES, MOVE_FAINT_ATTACK, MOVE_SHADOW_SNEAK}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Vivian[] = {
	...
	.moves = {MOVE_QUICK_ATTACK, MOVE_DOUBLE_KICK, MOVE_PLAY_NICE, MOVE_SPARK}
    }
};
...
static const struct TrainerMonNoItemDefaultMoves sParty_Hideo[] = {
    {
    .iv = 100,
    .lvl = 25,
    .species = SPECIES_KOFFING,
...
static const struct TrainerMonNoItemCustomMoves sParty_Keigo[] = {
    ...
    .lvl = 28,
    .species = SPECIES_KOFFING,
    .moves = {MOVE_FIRE_SPIN, MOVE_SELF_DESTRUCT, MOVE_SLUDGE, MOVE_SMOKESCREEN}
    },
    {
    .iv = 0,
    .lvl = 28,
    .species = SPECIES_NINJASK,
    .moves = {MOVE_SLASH, MOVE_DOUBLE_TEAM, MOVE_FURY_CUTTER, MOVE_SWORDS_DANCE}
    }
};

static const struct TrainerMonNoItemDefaultMoves sParty_Riley[] = {
    {
    .iv = 0,
    .lvl = 28,
    .species = SPECIES_SHEDINJA,
...
static const struct TrainerMonNoItemCustomMoves sParty_KimAndIris[] = {
    ...
    .lvl = 35,
    .species = SPECIES_ALTARIA,
    .moves = {MOVE_SING, MOVE_DRAGON_BREATH, MOVE_SAFEGUARD, MOVE_AIR_SLASH}
    },
    {
    .iv = 0,
    .lvl = 35,
...
static const struct TrainerMonNoItemCustomMoves sParty_TyraAndIvy[] = {
    ...
    .lvl = 20,
    .species = SPECIES_GRAVELER,
    .moves = {MOVE_DEFENSE_CURL, MOVE_ROLLOUT, MOVE_ROCK_POLISH, MOVE_MAGNITUDE}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_MelAndPaul[] = {
    ...
    .lvl = 27,
    .species = SPECIES_DUSTOX,
    .moves = {MOVE_VENOSHOCK, MOVE_PSYBEAM, MOVE_TOXIC, MOVE_PROTECT}
    },
    {
    .iv = 0,
    .lvl = 27,
...
static const struct TrainerMonNoItemCustomMoves sParty_JohnAndJay1[] = {
    ...
    .lvl = 39,
    .species = SPECIES_HARIYAMA,
    .moves = {MOVE_FOCUS_PUNCH, MOVE_SMELLING_SALT, MOVE_REST, MOVE_BELLY_DRUM}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Leonel[] = {
    ...
    .lvl = 30,
    .species = SPECIES_MANECTRIC,
    .moves = {MOVE_THUNDER, MOVE_ICE_FANG, MOVE_THUNDER_WAVE, MOVE_BITE}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Angelo[] = {
    ...
    .species = SPECIES_ILLUMISE,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SHOCK_WAVE, MOVE_QUICK_ATTACK, MOVE_CHARM, MOVE_SILVER_WIND}
    },
    {
    .iv = 100,
    .lvl = 17,
    .species = SPECIES_VOLBEAT,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SHOCK_WAVE, MOVE_QUICK_ATTACK, MOVE_CONFUSE_RAY, MOVE_SILVER_WIND}
    }
};

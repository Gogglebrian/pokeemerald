...
const u32 gFieldEffectObjectPic_Altaria[] = INCBIN_U32("graphics/field_effects/pics/altaria.4bpp");
const u16 gFieldEffectObjectPal_Altaria[] = INCBIN_U16("graphics/field_effects/palettes/altaria.gbapal.lz");

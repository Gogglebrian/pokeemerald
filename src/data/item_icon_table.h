const u32 *const gItemIconTable[ITEMS_COUNT + 1][2] =
{
    ...
    [ITEM_CATCH_UP_CANDY] = {gItemIcon_CatchUpCandy, gItemIconPalette_CatchUpCandy},
    // Battle items
	...
	[ITEM_TM51] = {gItemIcon_TM, gItemIconPalette_GhostTMHM}, // Shadow Claw
    [ITEM_TM52] = {gItemIcon_TM, gItemIconPalette_DarkTMHM}, // Dark Pulse
    [ITEM_TM53] = {gItemIcon_TM, gItemIconPalette_BugTMHM}, // X-Scissor
    [ITEM_TM54] = {gItemIcon_TM, gItemIconPalette_PoisonTMHM}, // Poison Jab
    [ITEM_TM55] = {gItemIcon_TM, gItemIconPalette_SteelTMHM}, // Flash Cannon
    [ITEM_TM56] = {gItemIcon_TM, gItemIconPalette_FairyTMHM}, // Dazzling Gleam

const u8 gMoveNames[MOVES_COUNT][MOVE_NAME_LENGTH + 1] =
{
	...
	//Gen 6
	[MOVE_DISARMING_VOICE] = _("DISARMINGCRY"), // Disarming Voice
	[MOVE_DRAINING_KISS] = _("DRAININGKISS"), // Draining Kiss
	[MOVE_PLAY_ROUGH] = _("PLAY ROUGH"), // Play Rough
    [MOVE_FAIRY_WIND] = _("FAIRY WIND"),
    [MOVE_MOONBLAST] = _("MOONBLAST"),
	[MOVE_DAZZLING_GLEAM]= _("DAZZLINGLEAM"), //Dazzling Gleam
	[MOVE_BABY_DOLL_EYES] = _("BABYDOLLEYES"), // Baby-Doll Eyes
	[MOVE_PLAY_NICE] = _("PLAY NICE"), // Play Nice

...
const u8 gText_PkmnNeedsToReplaceMove[] = _("{STR_VAR_1} wants to learn the\nmove {STR_VAR_2}.\pShould a move be deleted and\nreplaced with {STR_VAR_2}?");
const u8 gText_PkmnNeedsToReplaceMoveShort[] = _("Should a move be deleted and\nreplaced with {STR_VAR_2}?");
...
const u8 gText_12PoofForgotMove[] = _("1, 2, and… … … {PLAY_SE SE_BALL_BOUNCE_1}Poof!\p{STR_VAR_1} forgot how to\nuse {STR_VAR_2}.\pAnd…{PAUSE_UNTIL_PRESS}");
...
const u8 gText_PkmnBaseVar2StatIncreased[] = _("{STR_VAR_1}'s {STR_VAR_2} efforts\ngreatly improved!{PAUSE_UNTIL_PRESS}");
...
const u8 gText_PkmnFriendlyBaseVar2Fell[] = _("{STR_VAR_1} became friendlier!\nIts {STR_VAR_2} efforts declined.{PAUSE_UNTIL_PRESS}");
const u8 gText_PkmnVar2Reset[] = _("{STR_VAR_1}'s efforts in the\n{STR_VAR_2} stat were undone!{PAUSE_UNTIL_PRESS}");
const u8 gText_PkmnPotentialVar2StatFell[] = _("{STR_VAR_1}'s {STR_VAR_2} potential\nfell a bit.{PAUSE_UNTIL_PRESS}");
const u8 gText_PkmnAdoresBaseVar2Fell[] = _("{STR_VAR_1} adores you!\nIts {STR_VAR_2} efforts declined.{PAUSE_UNTIL_PRESS}");
const u8 gText_PkmnFriendlyBaseVar2CantFall[] = _("{STR_VAR_1} became friendlier!{PAUSE_UNTIL_PRESS}");
...
const u8 gText_MoveRelearnerAndPoof[] = _("1, 2, and… … … {PLAY_SE SE_BALL_BOUNCE_1}Poof!\p");

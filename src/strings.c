...
const u8 gText_DefaultNameBella[] = _("Belle");
...
const u8 gText_DefaultNameAubree[] = _("Aubrey");
...
const u8 gText_DadsAdvice[] = _("Dad's advice…\n{PLAYER}, there's a time and place for\leverything, but not now.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_EggFromHotSprings[] = _("An Egg which will\nhatch into a Pokémon.");
...
const u8 gPCText_Etcetera[] = _("EtcCetera");
...
const u8 gText_SeeYa[] = _("Log Off");
...
const u8 gText_Questionnaire[] = _("Questionaire");
...
const u8 gText_DifficultyInsane[] = _("Insane");
...
const u8 gText_PlusSymbol[] = _("{PLUS}");

...
static void DrawChoices_Follow(int selection, int y);
...
{
    [MENUITEM_MAIN_FOLLOW]		 = {DrawChoices_Follow,      ProcessInput_Options_Two},
...
} static const sItemFunctionsCustom[MENUITEM_CUSTOM_COUNT] =
{
	...
	[MENUITEM_CUSTOM_UNIT_SYSTEM]  = {DrawChoices_UnitSystem,  ProcessInput_Options_Two},
...
static const u8 *const sOptionMenuItemsNamesCustom[MENUITEM_CUSTOM_COUNT] =
{
	...
	[MENUITEM_CUSTOM_UNIT_SYSTEM] = sText_UnitSystem,
...
static bool8 CheckConditions(int selection)
{
    ...
    case MENU_MAIN:
        switch(selection)
        {
        case MENUITEM_MAIN_FOLLOW:			return TRUE;
    ...
    case MENU_CUSTOM:
		...
		case MENUITEM_CUSTOM_UNIT_SYSTEM:     return TRUE;
...
static const u8 sText_Desc_Follow_On[]			= _("Allow the first Pokémon in your\nparty to follow behind you.");
static const u8 sText_Desc_Follow_Off[]			= _("Keep your Pokémon inside their\nPoké Balls until needed.");
static const u8 *const sOptionMenuItemDescriptionsMain[MENUITEM_MAIN_COUNT][3] =
{
    [MENUITEM_MAIN_FOLLOW]		= {sText_Desc_Follow_On,			sText_Desc_Follow_Off,		sText_Empty},
...
static const u8 *const sOptionMenuItemDescriptionsCustom[MENUITEM_CUSTOM_COUNT][2] =
{
	...
	[MENUITEM_CUSTOM_UNIT_SYSTEM] = {sText_Desc_UnitSystemImperial, sText_Desc_UnitSystemMetric},
...
{
    [MENUITEM_MAIN_FOLLOW]   	= sText_Empty,
...
static const u8 *const sOptionMenuItemDescriptionsDisabledCustom[MENUITEM_CUSTOM_COUNT] =
{
	...
	[MENUITEM_CUSTOM_UNIT_SYSTEM] = sText_Empty,
...
static const u8 sText_TopBar_Main_Right[]   = _("{R_BUTTON}EXTRAS");
static const u8 sText_TopBar_Custom[]       = _("EXTRAS");
...
void CB2_InitOptionPlusMenu(void)
{
    ...
    case 6:
        ...
        sOptions->sel[MENUITEM_MAIN_FOLLOW]   	 = gSaveBlock2Ptr->optionsFollowOff;
		...
		sOptions->sel_custom[MENUITEM_CUSTOM_UNIT_SYSTEM] = gSaveBlock2Ptr->optionsUnitSystem;
...
static void Task_OptionMenuSave(u8 taskId)
{
	gSaveBlock2Ptr->optionsFollowOff      	= sOptions->sel[MENUITEM_MAIN_FOLLOW];
...
static void DrawChoices_Follow(int selection, int y)
{
    bool8 active = CheckConditions(MENUITEM_MAIN_FOLLOW);
    u8 styles[2] = {0};
    styles[selection] = 1;

    DrawOptionMenuChoice(sText_GenericOn, 104, y, styles[0], active);
    DrawOptionMenuChoice(sText_GenericOff, GetStringRightAlignXOffset(FONT_NORMAL, sText_GenericOff, 198), y, styles[1], active);
}
...
static void DrawChoices_UnitSystem(int selection, int y)
{
    bool8 active = CheckConditions(MENUITEM_CUSTOM_UNIT_SYSTEM);
    u8 styles[2] = {0};
    styles[selection] = 1;
...
static void DrawChoices_ExpScaling(int selection, int y)
{
    bool8 active = CheckConditions(MENUITEM_CUSTOM_EXPSCALING);
    u8 styles[2] = {0};
    styles[selection] = 1;

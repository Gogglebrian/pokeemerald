...
// follow mon option messages
extern const u8 Menu_FollowOn_Script[];
extern const u8 Menu_FollowOff_Script[];
extern const u8 Menu_LevelcapsOn_Script[];
extern const u8 Menu_LevelcapsOff_Script[];

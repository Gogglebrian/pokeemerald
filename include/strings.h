...
extern const u8 gText_MenuFollowOff[];
extern const u8 gText_MenuFollowOn[];
extern const u8 gText_MenuLevelcapsOff[];
extern const u8 gText_MenuLevelcapsOn[];
extern const u8 gText_MenuFollowOffMsg[];
extern const u8 gText_MenuFollowOnMsg[];
extern const u8 gText_MenuLevelcapsOffMsg[];
extern const u8 gText_MenuLevelcapsOnMsg[];
